...
namespace Rivet
{
    ...
    class WZjj_vvqq : public Analysis
    {
    public:
        /// Constructor
        RIVET_DEFAULT_ANALYSIS_CTOR(WZjj_vvqq);
        ...
        void init()
        {
            ...
            std::cout << "++++++assume .json for this WZjj_vvqq" << " is " << jsonfilestr << "\n";
            ...
            _cutflows_merged.addCutflow("WZjj_vvqq_selections", {
                                                                   "have_0_lep",
                                                                   "MET_cut_200GeV",
                                                                   "n_jets",
                                                                   "found_tag_jets",
            ...
            _cutflows_resolved.addCutflow("WZjj_vvqq_selections", {
                                                                    "have_0_lep",
                                                                    "MET_cut_200GeV",
                                                                    "n_jets",
                                                                    "found_tag_jets",
        ...
        void analyze(const Event &event)
        {
            ...
            if (nlep !=_jcuts["n_lepton_stable_0lep"])  vetoEvent; 
            ...
            if (_docut==1 && (MET_Et<_jcuts["MET_0lep"])) vetoEvent;
            ...
            FourMomentum fourvec_Vlep = fourvec_MET;
        ...
        double merged_MET_pt, merged_MET_Et, merged_MET_phi, merged_MET_eta;
        ...
        double merged_fjet_eta, merged_fjet_pt, merged_fjet_D2;
        double merged_fjet_DR_tagjet1, merged_fjet_DR_tagjet2, merged_fjet_Dphi_tagjet1, merged_fjet_Dphi_tagjet2;
        ...
        double resolved_MET_pt, resolved_MET_Et, resolved_MET_phi, resolved_MET_eta;
    ...
    RIVET_DECLARE_PLUGIN(WZjj_vvqq);

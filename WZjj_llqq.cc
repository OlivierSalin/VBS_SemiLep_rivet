...
namespace Rivet
{
    ...
    class WZjj_llqq : public Analysis
    {
    public:
        /// Constructor
        RIVET_DEFAULT_ANALYSIS_CTOR(WZjj_llqq);
        ...
        void init()
        {
            ...
            std::cout << "++++++assume .json for this WZjj_llqq" << " is " << jsonfilestr << "\n";
            ...
            _cutflows_merged.addCutflow("WZjj_llqq_selections", {
                                                                   "have_two_lep",
                                                                   "pt_lep1_2",
                                                                   "n_jets",
                                                                   "found_tag_jets",
            ...
            _cutflows_resolved.addCutflow("WZjj_llqq_selections", {
                                                                     "have_two_lep",
                                                                     "pt_lep1_2",
                                                                     "n_jets",
                                                                     "found_tag_jets",
    ...
    RIVET_DECLARE_PLUGIN(WZjj_llqq);

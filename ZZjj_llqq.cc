...
namespace Rivet
{
    ...
    class ZZjj_llqq : public Analysis
    {
    public:
        /// Constructor
        RIVET_DEFAULT_ANALYSIS_CTOR(ZZjj_llqq);
        ...
        void init()
        {
            ...
            std::cout << "++++++assume .json for this ZZjj_llqq" << " is " << jsonfilestr << "\n";
            ...
            _cutflows_merged.addCutflow("ZZjj_llqq_selections", {
                                                                   "have_two_lep",
                                                                   "pt_lep1_2",
                                                                   "n_jets",
                                                                   "found_tag_jets",
            ...
            _cutflows_resolved.addCutflow("ZZjj_llqq_selections", {
                                                                     "have_two_lep",
                                                                     "pt_lep1_2",
                                                                     "n_jets",
                                                                     "found_tag_jets",
    ...
    RIVET_DECLARE_PLUGIN(ZZjj_llqq);

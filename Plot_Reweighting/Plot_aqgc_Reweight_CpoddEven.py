...
categories_bis = {
    ...
    "FM3": [ROOT.kOrange+10, 9], "FM4": [ROOT.kOrange-3, 7], "FM5": [ROOT.kYellow, 4], "FM8": [ROOT.kYellow-6, 4],
...
def main():
    ...
    all_operators=["FM0","FM1","FM2","FM3","FM4","FM5","FM7","FM8","FM9",
                "FS0","FS1","FS2",
                "FT0","FT1","FT2","FT3","FT4","FT5","FT6","FT7","FM1odd","FM2odd","FM3odd","FM4odd","FM5odd","FM6odd","FT2odd","FT3odd","FT4odd","FT5odd","FT6odd"]

    op_odd=["FM1odd","FM2odd","FM3odd","FM4odd","FM5odd","FM6odd","FT2odd","FT3odd","FT4odd","FT5odd","FT6odd"]
    ...
    Special_name = "/Reweighting/CPodd/Validation/Newtest/20k/"


    Complement_path = f"CPodd/Validation/Plots/test/Mapping_bis/"
    ...
    for op_use in op_odd:
        eftdec_ops = [op_use]+ [ cpodd_to_cpeven[op_use] ]
        print(f"EFTDec ops: {eftdec_ops}")
        op_rwg = op_use[:2]  # e.g., "FM" for "FM1odd"
        ...
        for process in processes:
            for decay in decays:
                ...
                outPlot = f"{base_dir_plot}/{process}_{decay}/MappingCp_even/Mapping_{op_use}/"

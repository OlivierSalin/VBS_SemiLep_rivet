...
all_ops_cat = ["FM0","FM1","FM2","FM3","FM4","FM5","FS0","FS1","FS2"]
all_ops_cat = ["FM0",'FM4','FM9',"FM2","FS0",'FS1']
processes=["WpZ"]
decays=["llqq"]
order=[order_]


Complement_path="Helicity_aware/Test/"
...
def plot_histograms2(desired_num_bins, root_files_info, output_plot, Process_name, Xsec_model, norm_to_xsec=False, tree_name="Merged"):
    ...
    def setup_legend(num_entry):
        ...
        legend = ROOT.TLegend(0.75, 0.78 - length, 0.90, 0.85)
    ...
    def format_model_name(model_name):
        if "aqgc" in model_name:
            ...
            model_name= model_name.replace("Nohel", "Helicity ignorant")

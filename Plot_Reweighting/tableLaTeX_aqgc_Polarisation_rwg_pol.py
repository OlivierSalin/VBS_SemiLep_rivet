...
def parse_options():
    ...
    parser.add_option(
        "--xsec_file",
        default="/exp/atlas/salin/ATLAS/VBS_mc/VBS_Pol_Rivet/VBS_rivet/Plot_Reweighting/Tables/Cross_section/Validation/Validation_bis/VBS_cross_section_run2_reweighting_vbs_ALL.txt",

...
namespace Rivet
{
    ...
    class ZZjj_vvqq : public Analysis
    {
    public:
        /// Constructor
        RIVET_DEFAULT_ANALYSIS_CTOR(ZZjj_vvqq);
        ...
        void init()
        {
            ...
            std::cout << "++++++assume .json for this ZZjj_vvqq" << " is " << jsonfilestr << "\n";
            ...
            _cutflows_merged.addCutflow("ZZjj_vvqq_selections", {
                                                                   "have_0_lep",
                                                                   "MET_cut_200GeV",
                                                                   "n_jets",
                                                                   "found_tag_jets",
            ...
            _cutflows_resolved.addCutflow("ZZjj_vvqq_selections", {
                                                                    "have_0_lep",
                                                                    "MET_cut_200GeV",
                                                                    "n_jets",
                                                                    "found_tag_jets",
    ...
    RIVET_DECLARE_PLUGIN(ZZjj_vvqq);

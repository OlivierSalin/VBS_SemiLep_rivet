...
if __name__ == "__main__":
    ...
    for process,decay in proc_decays_tuple:
        for op in all_ops_cat:
            ...
            path_hist_base =f"/exp/atlas/salin/ATLAS/VBS_mc/eft_files/Histograms/Reweighting/Validation/MCRequest/test/Stats/{nb_events_k}k/{opts.type_MC}//"

...
namespace Rivet
{
    ...
    class WW_lvqq : public Analysis
    {
    public:
        /// Constructor
        RIVET_DEFAULT_ANALYSIS_CTOR(WW_lvqq);
        ...
        void init()
        {
            ...
            std::cout << "++++++assume .json for this WW_lvqq" << " is " << jsonfilestr << "\n";
            ...
            _cutflows_merged.addCutflow("WW_lvqq_selections", {
                                                                   "have_1_lep",
                                                                   "pt_lep1_MET_cut_80",
                                                                   "n_jets",
                                                                   "found_tag_jets",
            ...
            _cutflows_resolved.addCutflow("WW_lvqq_selections", {
                                                                    "have_1_lep",
                                                                    "pt_lep1_MET_cut_80",
                                                                     "n_jets",
                                                                     "found_tag_jets",

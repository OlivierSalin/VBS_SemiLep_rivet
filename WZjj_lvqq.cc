...
namespace Rivet
{
    ...
    class WZjj_lvqq : public Analysis
    {
    public:
        /// Constructor
        RIVET_DEFAULT_ANALYSIS_CTOR(WZjj_lvqq);
        ...
        void init()
        {
            ...
            std::cout << "++++++assume .json for this WZjj_lvqq" << " is " << jsonfilestr << "\n";
            ...
            _cutflows_merged.addCutflow("WZjj_lvqq_selections", {
                                                                   "have_1_lep",
                                                                   "pt_lep1_MET_cut_80",
                                                                   "n_jets",
                                                                   "found_tag_jets",
            ...
            _cutflows_resolved.addCutflow("WZjj_lvqq_selections", {
                                                                    "have_1_lep",
                                                                    "pt_lep1_MET_cut_80",
                                                                     "n_jets",
                                                                     "found_tag_jets",
    ...
    RIVET_DECLARE_PLUGIN(WZjj_lvqq);

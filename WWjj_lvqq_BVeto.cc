...
namespace Rivet
{
    ...
    class WWjj_lvqq_BVeto : public Analysis
    {
    public:
        /// Constructor
        RIVET_DEFAULT_ANALYSIS_CTOR(WWjj_lvqq_BVeto);
        ...
        void init()
        {
            ...
            std::cout << "++++++assume .json for this WWjj_lvqq_BVeto" << " is " << jsonfilestr << "\n";
            ...
            _cutflows_merged.addCutflow("WWjj_lvqq_BVeto_selections", {
                                                                   "have_1_lep",
                                                                   "pt_lep1_MET_cut_80",
                                                                   "n_jets",
                                                                   "found_tag_jets",
            ...
            _cutflows_resolved.addCutflow("WWjj_lvqq_BVeto_selections", {
                                                                    "have_1_lep",
                                                                    "pt_lep1_MET_cut_80",
                                                                     "n_jets",
                                                                     "found_tag_jets",
    ...
    RIVET_DECLARE_PLUGIN(WWjj_lvqq_BVeto);

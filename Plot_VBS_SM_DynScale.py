...
Complement_path="/SM_sample/MG_gen_prod/MC_request/Run3_prod_new/WZjj_ZZjj/WZjj/DynScale/Weight/"
...
Run_model_name = ["Run2_Old_prod","Run2_DynScale_2","Run2_DynScale_default","Run2_DynScale_custom"]

Special_name = "/SM_prod/Dynscale/Weights/Run2/"
Run_model_name = ["Run2_Old_prod","Run2_DynScale_Weights"]
Run_model_name = ["Run2_DynScale_weights"]
...
color_root = [ROOT.kBlack,ROOT.kRed, ROOT.kBlue, ROOT.kGreen+3, ROOT.kYellow, ROOT.kOrange, ROOT.kPink, ROOT.kViolet, ROOT.kCyan, ROOT.kTeal, ROOT.kAzure, ROOT.kSpring, ROOT.kMagenta, ROOT.kGray, ROOT.kWhite]

...
output_table = f"{base_dir_bis}/{opts.Ana}/Plots/Table/New_/DOCUT_{opts.DOCUT}/"
...
Details_dir= "Tables/Vhad_first2/Vhad/"
...
# Save the figure as a PDF
plt.savefig(output_dir_+f'table_Vhad_{opts.Name}.pdf', format='pdf')

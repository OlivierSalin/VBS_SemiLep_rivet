...
Complement_path="/Cross_term/"
Complement_path="/Models/Stats_100k/Eboli_aqgc_new/"

if not opts.linear:
    base_dir_plot = f"/exp/atlas/salin/ATLAS/VBS_mc/Plots/Plot_aqgc_Model_test/Error_bar_Eboli_aqgc/{Complement_path}/bins_{opts.bins}/"
else:
    base_dir_plot = f"/exp/atlas/salin/ATLAS/VBS_mc/Plots/Plot_aqgc_Model_test/Error_bar_Eboli_aqgc/{Complement_path}/bins_{opts.bins}/"

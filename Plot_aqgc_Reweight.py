...
Complement_path="Plot_rweighting_study/TypeOp_only/MoreStat_100k/FS/"
...
all_ops_both= ["FT0","FT1","FT2","FT3","FT4","FT5","FT6"]
#all_ops_both= ["FT0","FT2","FT6"]
#all_ops_both= ["FT0"]
